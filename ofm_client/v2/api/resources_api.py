...
class ResourcesApi(object):
    ...
    def resources_get(self, **kwargs):  # noqa: E501
        """Retrieve a collection of Resource records.  # noqa: E501
    ...
    def resources_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'page' in params and params['page'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `resources_get`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='list[GetResourceDto]',  # noqa: E501
    ...
    def resources_id_get(self, id, **kwargs):  # noqa: E501
        """Retrieve a specific Resource record.  # noqa: E501
        ...
        :param async_req bool
        :param str id: Globally unique identifier (GUID) of a Resource record (required)
    ...
    def resources_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if 'id' in params and not re.search(r'\\{?[a-zA-Z0-9]{8}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{12}\\}?', params['id']):  # noqa: E501
            raise ValueError("Invalid value for parameter `id` when calling `resources_id_get`, must conform to the pattern `/\\{?[a-zA-Z0-9]{8}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{12}\\}?/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetResourceDto',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def resources_search_post(self, **kwargs):  # noqa: E501
        """Retrieve a collection of Resource records.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resources_search_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PostResourceSearchDto body:
        :return: list[GetResourceDto]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.resources_search_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.resources_search_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def resources_search_post_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve a collection of Resource records.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.resources_search_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method resources_search_post" % key
                )
            params[key] = val
        del params['kwargs']
